...
const Hero: React.FC = () => {
    return (
        ...
        >
            ...
            <h1 className="animate-fade-in delay-200 -translate-y-4 text-balance bg-gradient-to-br from-black from-30% to-black/40 bg-clip-text py-6 text-4xl font-medium leading-none tracking-tighter text-transparent opacity-0 sm:text-5xl md:text-6xl lg:text-7xl dark:from-white dark:to-white/80">
                Habilidades de Conversação Hoje!
                <br className="hidden md:block" />
            </h1>
            <p className="animate-fade-in delay-400 mb-6 -translate-y-4 text-balance text-lg tracking-tight text-gray-300 opacity-0 md:text-xl">
