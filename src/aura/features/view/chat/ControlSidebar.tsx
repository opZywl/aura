...
import { Sun, Moon, ArrowLeft, Info, Maximize, Minimize, Menu, Plus, Settings, Palette, Eye } from "lucide-react"
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuLabel,
  ...
  return (
    ...
    >
      <div className="flex-1 flex flex-col items-center space-y-4">
        ...
        >
          <Menu className="w-5 h-5" style={getIconStyle()} />
        </Button>
        ...
        <Button
          ...
          style={getButtonStyle()}
        >
          <Eye className="w-5 h-5" style={getIconStyle()} />
        </Button>
