            ...
            >
                <div className="flex-1 flex flex-col items-center space-y-4">
                    ...
                    <DropdownMenu>
                        ...
                        >
                            <DropdownMenuLabel className="chat-glow-title">Configurações de Performance</DropdownMenuLabel>
                            <DropdownMenuSeparator />
                            <div className="p-3 space-y-3">
                                <div className="flex items-center justify-between">
                                    <span className="text-sm font-medium chat-fade-text">Modo Performance</span>
                                    <Switch checked={performanceSettings.performanceMode} onCheckedChange={handlePerformanceModeChange} />
                                </div>
                                <div className="flex items-center justify-between">
                                    <span className="text-sm chat-fade-text">Animações Reduzidas</span>
                                    <Switch
                                ...
                                <div className="flex items-center justify-between">
                                    <span className="text-sm chat-fade-text">Taxa de Quadros Baixa</span>
                                    <Switch
                                ...
                                <div className="flex items-center justify-between">
                                    <span className="text-sm chat-fade-text">Otimização de Memória</span>
                                    <Switch
                    ...
                    <DropdownMenu>
                        ...
                        >
                            <DropdownMenuLabel className="text-lg font-bold chat-glow-title">Personalização Visual</DropdownMenuLabel>
                            <DropdownMenuSeparator />
                            <div className="p-4 space-y-6">
                                {/* Predefined Themes */}
                                <div>
                                    <h3 className="text-sm font-medium mb-3 chat-fade-text">Temas Predefinidos</h3>
                                ...
                                <div className="space-y-4">
                                    <h3 className="text-sm font-medium chat-glow-title">Configurações de Brilho</h3>

                                    <div className="flex items-center justify-between">
                                        <span className="text-sm chat-fade-text">Efeitos de Brilho</span>
                                        <Switch
                                        ...
                                        <>
                                            <div className="space-y-2">
                                                <div className="flex justify-between">
                                                    <span className="text-sm chat-fade-text">Intensidade do Brilho</span>
                                            ...
                                            <div className="space-y-2">
                                                <div className="flex justify-between">
                                                    <span className="text-sm chat-fade-text">Espessura do Brilho</span>
                                            ...
                                            <div className="flex items-center justify-between">
                                                <span className="text-sm chat-fade-text">Animação do Brilho</span>
                                                <Switch
                                ...
                                {/* Fade Effects */}
                                <div className="space-y-4">
                                    <h3 className="text-sm font-medium chat-glow-title">Efeitos de Fade</h3>

                                    <div className="flex items-center justify-between">
                                        <span className="text-sm chat-fade-text">Efeitos de Fade</span>
                                        <Switch
                                    ...
                                    {themeSettings.fadeEnabled && (
                                        <>
                                            <div className="space-y-2">
                                                <span className="text-sm chat-fade-text">Modo de Fade</span>
                                            ...
                                            <div className="space-y-2">
                                                <div className="flex justify-between">
                                                    <span className="text-sm chat-fade-text">Velocidade do Movimento</span>
                                ...
                                {/* Text Animations */}
                                <div className="flex items-center justify-between">
                                    <span className="text-sm font-medium chat-glow-title">Animações de Texto</span>
                                    <Switch
                                ...
                                <div className="text-xs text-center opacity-70">
                                    <div className="chat-fade-text">
                                        Glow: {themeSettings.glowEffects ? "Sim" : "Não"} | Fade:{" "}
                                        {themeSettings.fadeEnabled ? "Sim" : "Não"} | Anim: {themeSettings.textAnimations ? "Sim" : "Não"}
                                    </div>
