...
import { Info, Edit3, Check, X, Bell, BellOff, MessageSquare, MoreVertical, Archive } from "lucide-react"
...
export default function ChatHeader({
    ...
    // Adicionar useEffect para sincronizar quando a conversa mudar
    useEffect(() => {
    ...
    const renderPlatformIcon = () => {
        ...
        switch (platform.toLowerCase()) {
            ...
            case "whatsapp":
                return (
                    <div className="w-5 h-5 mr-1">
                        <Image src="/redesociais/whatsapp.svg" alt="WhatsApp" width={20} height={20} className="object-contain" />
                    </div>
                )
            case "messenger":
                return (
                    <div className="w-5 h-5 mr-1">
                        <Image src="/redesociais/messenger.svg" alt="Messenger" width={20} height={20} className="object-contain" />
                    </div>
                )
            default:
                    ...
                    <div>
                        ...
                        <div className="flex items-center space-x-2 mt-1">
                            ...
                            <div className="flex items-center">
                                ...
                                >
                  {conversation.situacao || "Em Atendimento"}
                </span>
                            </div>
                        </div>
                    </div>
