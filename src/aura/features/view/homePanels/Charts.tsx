...
const Charts: React.FC = () => {
  ...
  const lineData = [
    ...
    { x: 90, y: 65, value: "$22,800", month: "Feb" },
    { x: 130, y: 80, value: "$18,500", month: "Mar" },
    { x: 170, y: 65, value: "$27,500", month: "Apr" },
    { x: 210, y: 50, value: "$32,100", month: "May" },
  ...
  const barData = [
    { x: 45, y: 55, height: 50, value: "1,250", month: "Feb" },
    { x: 95, y: 30, height: 75, value: "2,100", month: "Mar" },
    { x: 145, y: 65, height: 40, value: "890", month: "Apr" },
    { x: 195, y: 45, height: 60, value: "1,650", month: "May" },
    ...
    <div className="grid grid-cols-2 gap-4">
      ...
      <div className={`rounded-lg p-3 group relative ${theme === "dark" ? "card-hover" : "card-hover-light"}`}>
        <div className="flex items-center justify-between mb-3">
          <h3 className={`font-semibold text-sm ${theme === "dark" ? "text-white" : "text-gray-900"}`}>Order</h3>
      ...
      <div className={`rounded-lg p-3 group relative ${theme === "dark" ? "card-hover" : "card-hover-light"}`}>
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className={`text-xs ${theme === "dark" ? "text-gray-400" : "text-gray-600"}`}>Filter</span>
            <span className={`text-xs ${theme === "dark" ? "text-gray-400" : "text-gray-600"}`}>Current Week</span>
            <MoreHorizontal className={`w-4 h-4 ${theme === "dark" ? "text-gray-400" : "text-gray-600"}`} />
          </div>
        </div>
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-2">
            {[
              { color: "bg-yellow-500", label: "Messages", value: "321" },
              { color: "bg-cyan-500", label: "Calls", value: "222" },
              { color: "bg-purple-500", label: "Time on call", value: "19" },
              { color: "bg-pink-500", label: "Top conversations", value: "56" },
            ].map((item, index) => (
              <div
                key={index}
