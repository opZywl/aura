...
const Stats: React.FC = () => {
  ...
  const teamMembers = [
    { name: "Adriana ...", role: "Gerente de Projeto", time: "há 2 min" },
    { name: "Lucas Almeida", role: "Desenvolvedor Full-Stack", time: "há 2 min" },
    { name: "Caio Gabriel", role: "Arquiteto de Software", time: "há 2 min" },
    { name: "Mateus Theobald", role: "Documentação de Usuário", time: "há 2 min" },
    { name: "Ryhan Yassin", role: "Analista de Qualidade", time: "há 2 min" }
  ];
      ...
      <div className={`w-80 p-4 space-y-4 overflow-y-auto ${theme === "dark" ? "stats-sidebar" : "stats-sidebar-light"}`}>
        ...
        <div>
          <div className="flex items-center justify-between mb-3">
            <h3 className={`text-sm font-semibold ${theme === "dark" ? "text-white" : "text-gray-900"}`}>Membro da Equipe</h3>
            <div className="flex items-center space-x-2">
              <span className={`text-xs ${theme === "dark" ? "text-gray-400" : "text-gray-600"}`}>Recentes</span>
            ...
            {teamMembers.map((member, index) => (
                ...
                >
                  <div className="w-7 h-7 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full flex items-center justify-center">
                    <span className="text-xs font-medium text-white">YZY</span>
                  </div>
        ...
        <div className={`rounded-lg p-3 ${theme === "dark" ? "card-hover" : "card-hover-light"}`}>
          <div className="flex items-center justify-between mb-2">
            <div>
              <h4 className={`text-xs ${theme === "dark" ? "text-gray-400" : "text-gray-600"}`}>Principais Conversas</h4>
            ...
            <div className={`text-xs ${theme === "dark" ? "text-gray-400" : "text-gray-600"}`}>Diário</div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-1">
              <div className="flex items-center justify-between text-xs">
                <span className={theme === "dark" ? "text-gray-400" : "text-gray-600"}>Mensagens</span>
                <span className={`font-semibold ${theme === "dark" ? "text-white" : "text-gray-900"}`}>321</span>
              </div>
              <div className="flex items-center justify-between text-xs">
                <span className={theme === "dark" ? "text-gray-400" : "text-gray-600"}>Chamadas</span>
