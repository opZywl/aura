...
const Content: React.FC = () => {
  ...
  const metrics = [
    ...
    {
      title: "Renovações de Assinatura",
      value: "1200",
      change: "+1,35%",
      changeType: "positive" as const,
      subtitle: "da semana passada",
  ...
  const projects = [
    {
      ...
      subtitle: "Atribuição de Tarefas de Notícias",
      time: "há 4 h",
      avatars: 2,
    },
    {
      title: "Jiraaaaaaa",
      subtitle: "Atribuição de Tarefas",
      time: "há 4 h",
      avatars: 2,
    },
    {
  ...
  return (
      ...
      >
        ...
        {/* Linha de Gráficos Inferior */}
        <div className="grid grid-cols-3 gap-4">
          <div className={`rounded-lg p-3 group relative ${theme === "dark" ? "card-hover" : "card-hover-light"}`}>
            <div className="flex items-center justify-between mb-2">
              <h3 className={`font-semibold text-sm ${theme === "dark" ? "text-white" : "text-gray-900"}`}>Mensagens</h3>
              <span className={`text-xs ${theme === "dark" ? "text-gray-400" : "text-gray-600"}`}>Diário</span>
            </div>
            ...
            <div className="space-y-1">
              <div className="flex justify-between text-xs">
                <div className="flex items-center space-x-1">
                  ...
                  <span className={theme === "dark" ? "text-gray-400" : "text-gray-600"}>Recebidas</span>
                </div>
              ...
              <div className="flex justify-between text-xs">
                <div className="flex items-center space-x-1">
                  ...
                  <span className={theme === "dark" ? "text-gray-400" : "text-gray-600"}>Enviadas</span>
                </div>
              ...
              <div className="flex justify-between text-xs">
                <div className="flex items-center space-x-1">
                  ...
                  <span className={theme === "dark" ? "text-gray-400" : "text-gray-600"}>Perdidas</span>
                </div>
            ...
            <div className="h-16 mt-2 overflow-visible relative">
              ...
              {/* Dica para as linhas de mensagem */}
              {hoveredLine && (
                  <div
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between text-xs">
                <div className="flex items-center space-x-2">
                  ...
                  <span className={theme === "dark" ? "text-gray-300" : "text-gray-700"}>Design de Produto</span>
                </div>
                <div className="text-right">
                  <div className={theme === "dark" ? "text-white" : "text-gray-900"}>26 Projetos</div>
                  <div className={theme === "dark" ? "text-gray-400" : "text-gray-600"}>4 Membros</div>
                </div>
              </div>
              <div className="flex items-center justify-between text-xs">
                <div className="flex items-center space-x-2">
                  ...
                  <span className={theme === "dark" ? "text-gray-300" : "text-gray-700"}>Design UI/UX</span>
                </div>
                <div className="text-right">
                  <div className={theme === "dark" ? "text-white" : "text-gray-900"}>26 Projetos</div>
                  <div className={theme === "dark" ? "text-gray-400" : "text-gray-600"}>4 Membros</div>
              ...
              <div className="flex items-center justify-between text-xs">
                <div className="flex items-center space-x-2">
                  ...
                  <span className={theme === "dark" ? "text-gray-300" : "text-gray-700"}>Desenvolvimento Web</span>
                </div>
                <div className="text-right">
                  <div className={theme === "dark" ? "text-white" : "text-gray-900"}>26 Projetos</div>
                  <div className={theme === "dark" ? "text-gray-400" : "text-gray-600"}>4 Membros</div>
          ...
          <div className={`rounded-lg p-3 ${theme === "dark" ? "card-hover" : "card-hover-light"}`}>
            <h3 className={`text-xs mb-2 ${theme === "dark" ? "text-gray-400" : "text-gray-600"}`}>Semana Atual</h3>
