...
import { SettingsProvider } from "./src/aura/contexts/AnimationsSettingsContext"
import { useTheme } from "next-themes"
import AuraFlowBot from "./src/aura/features/view/flow/aura-flow-bot"
...
function HomeContent() {
    ...
    const serviceAreas = [
        ...
        {
            title: "Suporte",
            description: "Atendimento ao cliente 24/7 com IA",
            icon: (
        ...
        {
            title: "Cobrança",
            description: "Gestão automatizada de cobranças",
            icon: (
                <DollarSign className={`h-8 w-8 sm:h-10 sm:w-10 ${theme === "dark" ? "text-gray-300" : "text-gray-600"}`} />
            ),
        },
        {
            title: "Agendamento",
            description: "Agende compromissos automaticamente",
        ...
        {
            title: "Personalizado",
            description: "Soluções customizadas para seu negócio",
                    ...
                    >
                        <div className="mb-4 sm:mb-6">
                            <div className="inline-flex items-center px-4 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-purple-900/40 via-blue-900/40 to-purple-900/40 border border-purple-500/30 rounded-full text-xs sm:text-sm text-white backdrop-blur-sm shadow-lg shadow-purple-500/20 relative overflow-hidden">
                                ...
                                <span className="relative z-10 font-medium">Powered by AI</span>
                            </div>
                        </div>
                        <h1
                        ...
                        <div className={`text-xs sm:text-sm mt-6 sm:mt-8 max-w-2xl mx-auto px-4 ${getSecondaryContrastClass()}`}>
                            {fadeEffects ? (
                                <AnimatedText
                                    text="Transforme seu negócio com agentes de IA inteligentes que trabalham 24/7"
                                    className={`text-xs sm:text-sm ${getSecondaryContrastClass()}`}
                                />
                            ) : (
                                <span>Transforme seu negócio com agentes de IA inteligentes que trabalham 24/7</span>
                            )}
                        </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
                            ...
                            >
                                <p className={`text-base sm:text-lg lg:text-xl leading-relaxed ${getSecondaryContrastClass()}`}>
                                    Agentes de IA são assistentes virtuais inteligentes que podem executar tarefas complexas de forma
                                    autônoma.
                                </p>
                                <p
                                    className={`text-base sm:text-lg lg:text-xl leading-relaxed mt-4 sm:mt-6 ${getSecondaryContrastClass()}`}
                                >
                                    Eles aprendem com cada interação e se adaptam às necessidades do seu negócio.
                                </p>
                            </motion.div>
                ...
                <section className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 relative">
                    ...
                    >
                        ...
                        <p className={`text-lg sm:text-xl mb-8 sm:mb-10 ${getSecondaryContrastClass()}`}>
                            Agende uma demonstração gratuita e veja como a IA pode transformar seu negócio
                        </p>
